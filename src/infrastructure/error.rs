...
impl From<utils::redis_client::RedisError> for AppError {
    fn from(value: utils::redis_client::RedisError) -> Self {
        use utils::redis_client::RedisError as UtilsRedisError;
        match value {
            UtilsRedisError::Redis(e) => AppError::RedisError(e),
            UtilsRedisError::NotFound(msg) => AppError::NotFound(msg),
            UtilsRedisError::InvalidSession(msg) => AppError::InvalidSessionError(msg),
            UtilsRedisError::Serialization(msg) | UtilsRedisError::Parse(msg) => {
